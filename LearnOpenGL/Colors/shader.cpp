...
int main()
{
	...
	Shader lightingShader((path + "colors.vs").c_str(), (path + "colors.fs").c_str());
	Shader lightCubeShader((path + "light_cube.vs").c_str(), (path + "light_cube.fs").c_str());
	...
	glGenVertexArrays(1, &cubeVAO);//VAO: vertex array object
	glGenBuffers(1, &VBO);
