...
int main()
{
	...
	Shader ourShader("./Shaders_Ex2_Offset/shader.vs", "./Shaders_Ex2_Offset/shader.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.use();
		ourShader.setFloat("horizonOffset", 0.5f);//!!!:set 0.5f as the offset to reach the right side of the screen.
